...
var ImageEditor = React.createClass({
    ...
    render: function() {
        ...
        return (
            <EditorMenu />
            <Surface width={surfaceWidth} height={surfaceHeight} left={0} top={0} enableCSSLayout={true}>
                <Group style={this.getPageStyle()}>
                    <Group style={menuStyle}>
                        <Text style={textStyle}>This is the menu</Text>
                    </Group>
                    <Group style={this.getImageGroupStyle()}>
                        <Image style={imageStyle} src="/imgs/test.jpg" alt="hehehe" fadeIn={true}/>
                    </Group>
                </Group>
            </Surface>
        );
...
window.onload = function() {
    ReactDOM.render(
        <div>
            <ImageEditor width={700} height={400} />,
        </div>,
