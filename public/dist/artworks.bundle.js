...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArtworkList = React.createClass({ displayName: "ArtworkList",
	    ...
	    render: function () {
	        ...
	        return React.createElement("div", { id: "artwork-list-page" }, React.createElement("header", { className: "ui header breadcrumb" }, React.createElement("a", { className: "section", href: "#" }, username), React.createElement("div", { className: "divider" }, " / "), React.createElement("a", { className: "section", href: listUrl }, "Artworks")), React.createElement(ArtworkPage, { list: this.state.list }), React.createElement(PageNav, { num: this.state.pages, active: this.state.currentPage, handleChange: this.changePage }));
	    }
	});
	...
	var ArtworkPage = React.createClass({ displayName: "ArtworkPage",
	    render: function () {
	        var items = this.props.list.map(function (item, key) {
	            ...
	            return React.createElement("div", { className: "item", key: key }, React.createElement("div", { className: "content" }, React.createElement("a", { className: "header", href: url }, item.workTitle), React.createElement("div", { className: "description" }, "Created at ", item.creatTime)));
	        });
	...
	var PageNav = React.createClass({ displayName: "PageNav",
	    ...
	    produce: function (number, active) {
	        ...
	        if (active) {
	            return React.createElement("a", { className: "disable item", key: number }, number);
	        } else {
	            return React.createElement("a", { className: "item page-item", onClick: callback, key: number }, number);
	        }
	    },
	    ...
	    render: function () {
	        ...
	        return React.createElement("div", { id: "pagination-wrapper" }, React.createElement("div", { className: "ui pagination menu center aligned middle grid", id: "page-nav" }, items));
	    }
	});
